...
def show_artist(artist_id):
  ...
  past_shows = list(filter(lambda x: x.start_time < datetime.today(), artist.shows)) # Function to filter past shows
  upcoming_shows = list(filter(lambda x: x.start_time >= datetime.today(), artist.shows)) # Function to filter upcoming shows
